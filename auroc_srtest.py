...
- ✅ AUROC(image-level) + ROC curve 저장 추가
"""
...
from models.sr_ae import SR2_AE
...
# =======================================================
#  Label inference (폴더 구조 기반 GT)
#  - 기본: 경로에 '/good/' 포함 -> 정상(0)
#  - 그 외 -> 이상(1)
#  필요하면 너 데이터 구조에 맞게 여기만 바꾸면 됨.
# =======================================================
...
def main():
    ...
    AE_CKPT = "./results/checkpoints/sr2_ae_only_20260305_184535.pth"
    ...
    # 결과 저장 디렉토리
    # -------------------------
    result_dir = os.path.join(paths["results_dir"], "sr_dilate_test_4")
    ...
    with open(txt_path, "w", encoding="utf-8") as f:
        f.write("=== SR+AE Pixel-diff Histogram + Dilated Threshold Overlay + Image Score Results (+ AUROC) ===\n")
        ...
        f.write("rank\tlabel\timage_score\tamap_p95\tamap_max\tdil_thr_ratio(%)\toverflow\tpath\n")
